...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ActionList.cameraButtonPressed = () {};
    ActionList.searchButtonPressed = () {};
    ActionList.moreButtonText = ["New group","New broadcast","Linked devices","Starred messages","Settings"];
    ActionList.moreButtonPressed = [Container(),Container(),Container(),Container(),const Settings()];
